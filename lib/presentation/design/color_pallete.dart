...
class ColorPalette {
  static const Color primary = Color(0xFFD7634B);
  static const Color onPrimary = Color(0xFF3B120A);
  static const Color secondary = Color(0xFFD7944B);
  static const Color onSecondary = Color(0xFF61281C);
  static const Color tertiary = Color(0xFF337087);
  static const Color additional = Color(0xFF369C5C);
  ...
  static Color secondaryTextLight = Color(0xFF000000).withOpacity(0.8);

  static Color primaryTextDark = const Color(0xFFFFFFFF);
